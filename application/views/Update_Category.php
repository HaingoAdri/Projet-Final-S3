    ...
    <nav class="navbar navbar-expand-md  fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link " href="http://localhost/P_Final/ci306/User/admin">HOME <span class="sr-only">(current)</span></a>
                </li>
               
                <li class="nav-item">
                    <a class="nav-link " href="http://localhost/P_Final/ci306/User/admin">Categorie</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="http://localhost/P_Final/ci306/User/insert_Categorie">Add_Categorie</a>
                </li>
    ...
    <div id="projects" class="filter">
		<div class="container">
            ...
            <div class="row">
                ...
                <form class="needs-validation"action="http://localhost/P_Final/ci306/User/admin">
                <div class="row g-3">
                    <div class="col-sm-12">
                    <h4 for="firstName" class="form-h4bel">Id_Categorie</h4>
                    <br>
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-12">
                        <h4 for="firstName" class="form-h4bel">Name</h4>
                        <br>
                        <input type="text" class="form-control" id="firstName" placeholder="Le nom de votre categories" value="" required>
                        <br>    
                    </div> 

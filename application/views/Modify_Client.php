    ...
    <nav class="navbar navbar-expand-md  fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link " href="http://localhost/P_Final/ci306/User_Client/user">HOME <span class="sr-only">(current)</span></a>
                </li>
               
                <li class="nav-item">
                    <a class="nav-link " href="http://localhost/P_Final/ci306/User_Client/user">Categorie</a>
                </li>
		...
		<div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h2>Modifier Objets</h2>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
            <div class="row">
                <div class="col-lg-10">
               
                <form class="needs-validation"action="http://localhost/P_Final/ci306/User_Client/user">
                <div class="row g-3">
                    <div class="col-sm-12">
                        <h4 for="firstName" class="form-h4bel">Id_Objets</h4>
                        <br>
                        <input type="text" class="form-control" id="firstName" placeholder="L'id de votre categories" value="" required>
                    </div>
                    <br>
                    <div class="col-sm-12">
                        <h4 for="firstName" class="form-h4bel">Nom</h4>
                        <br>
                        <input type="text" class="form-control" id="firstName" placeholder="Le nom de votre categories" value="" required>
                    </div>
                        <br>  
                    <div class="col-sm-12">
                        <h4 for="firstName" class="form-h4bel">Prix</h4>
                        <br>
                        <input type="text" class="form-control" id="firstName" placeholder="Le nom de votre categories" value="" required>
                    </div>  
                    <div class="col-sm-12">
                        <h4 for="firstName" class="form-h4bel">Description</h4>
                        <br>
                        <input type="text" class="form-control" id="firstName" placeholder="Le nom de votre categories" value="" required>
                    </div>

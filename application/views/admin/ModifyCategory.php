	...
	<section class="py-0">
		<div class="row vh-100">
			<div class="col-sm-12 col-lg-6 mx-auto my-auto">
				...
				<form action="<?= site_url('admin/mod') ?>" method="POST"class="form">
					<input type="hidden" value="<?=$category['idCategories'] ?>" name="idCategory">
					<div class="mb-3">
						<label for="" class="form-label"> Enter the new category name </label>
						<input type="text" class="form-control" value="<?= $category['nom'] ?>" name="category">
					</div>
					<div class="mb-3">
